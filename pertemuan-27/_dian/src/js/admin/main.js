...
window.openEditModal = function(event){
  ...
  document.querySelector("#btn-save-update-product").addEventListener("click", (e) => {
    document.querySelector("#form-edit-product").requestSubmit();
  })
}

document.querySelector("#form-edit-product").addEventListener("submit", handleUpdateData);
