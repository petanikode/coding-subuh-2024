...
document.addEventListener("congratulations", handleCongratulations);

const congratulationsEvent = new Event("congratulations");
...
function handleSubmit(event) {
  ...
  document.dispatchEvent(congratulationsEvent);
}

function handleCongratulations() {
  console.log("Selamat, anda berhasil menjadi user");
